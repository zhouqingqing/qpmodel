...
struct TypeBase
{
    static constexpr SQLType precedence_[static_cast<uint64_t>(SQLType::SQL_TYPE_LAST)]{
        SQLType::SQL_TYPE_ANY,      SQLType::SQL_TYPE_INTEGER, SQLType::SQL_TYPE_LONG,
        SQLType::SQL_TYPE_NUMERIC,  SQLType::SQL_TYPE_DOUBLE,  SQLType::SQL_TYPE_BOOL,
        SQLType::SQL_TYPE_DATETIME, SQLType::SQL_TYPE_VARCHAR, SQLType::SQL_TYPE_CHAR
    };
};
...
class TableDef : public UseCurrentResource
{
    ...
    TableDef* Clone()
    {
        ...
        std::cerr << "MEMDEBUG: " << __FILE__ << ":" << __LINE__
                  << ": NEW TableDef : " << (void*)clone << " : " << *name_ << std::endl;
#endif // _DEBUG
...
#ifdef _DEBUG
        std::cerr << "MEMDEBUG: " << __FILE__ << ":" << __LINE__
                  << ": DEL TableDef : " << (void*)this << " : " << *name_ << std::endl;
#endif // _DEBUG

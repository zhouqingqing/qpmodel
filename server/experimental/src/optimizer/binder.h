    ...
    ~Binder()
    {
        ...
        for (auto t : tablesInScope_) {
            ...
            std::cerr << "MEMDEBUG: " << __FILE__ << ":" << __LINE__
                      << ": DEL TBLSCOPE ENTRY: TBLREF : " << (void*)tref << " : TBLDEF "
                      << (void*)tref->tabDef_ << " " << *(tref->tabDef_->name_) << std::endl;
#endif // _DEBUG
...
#ifdef _DEBUG
        std::cerr << "MEMDEBUG: " << __FILE__ << ":" << __LINE__
                  << ": NEW TBLSCOPE ENTRY: TBLREF : " << (void*)tref << " : TBLDEF "
                  << (void*)tref->tabDef_ << " " << *(tref->tabDef_->name_) << std::endl;
#endif // _DEBUG

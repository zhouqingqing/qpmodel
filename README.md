...
- The optimizer also expose a DataSet like interface which demonstrates language intergration. Another example calculating Pi with Monte-Carlo can be found in Unittest.
```c#
